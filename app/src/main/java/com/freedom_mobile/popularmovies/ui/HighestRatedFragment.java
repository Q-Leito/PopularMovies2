...
public class HighestRatedFragment extends Fragment {
    public static final String TAG = HighestRatedFragment.class.getSimpleName();
    ...
    @Bind(R.id.highestRatedRecyclerView) RecyclerView mRecyclerView;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            Movie.mHighestRatedMovieList = (HashMap<String, Movie>)
                    savedInstanceState.getSerializable(KEY_MOVIE_LIST);
            mMovie = savedInstanceState.getParcelable(MOVIE_DATA);
        }

        if (getActivity() != null) {
            mUtils = new Utils(getActivity());
            mUtils.getMovieData(Urls.SORT_BY_VOTE_AVERAGE_DESC,
                    mMovie,
                    TAG,
                    Movie.mHighestRatedMovieList,
                    mRecyclerView,
                    mCallbacks);
        }
    }
    ...
    public void onSaveInstanceState(Bundle state) {
        ...
        state.putSerializable(KEY_MOVIE_LIST, Movie.mHighestRatedMovieList);
